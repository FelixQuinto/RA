        ...
        <form action="Pregunta_Seguridad.php" method="POST">     
          <div class="container col px-4 py-5">
                <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                      <div class="mb-3">
                      <p class="text-dark">
                                  <h4><label for="text" class="form-label">Por favor, Ingrese su correo de usuario </label></h4>
                                  <input type="text" class="form-control" size="50" maxlength="50" name="Correo" required>
